...
const NAV_ITEMS = [
  ...
  { key: "recertification", label: "Recertification", component: <Recertification /> },
        ...
        return (
          <div style={{ 
            ...
            <div style={{ 
              ...
              onClick={() => handleNavClick("sot_upload")}
              onMouseEnter={(e) => {
                e.target.style.transform = "translateY(-4px)";
                e.target.style.boxShadow = "0 12px 32px rgba(0, 123, 255, 0.12)";
              }}
              ...
              onClick={() => handleNavClick("user_summary")}
              onMouseEnter={(e) => {
                e.target.style.transform = "translateY(-4px)";
                e.target.style.boxShadow = "0 12px 32px rgba(0, 123, 255, 0.12)";
              }}
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{ color: "#4a5568", fontSize: 15, lineHeight: 1.6 }}>Manage panel configurations and settings</p>
              </div>
              <div style={{ 
                background: "linear-gradient(135deg, #ffffff 0%, #f0f4ff 100%)", 
                padding: 32, 
              ...
              onClick={() => handleNavClick("recertification")}
              onMouseEnter={(e) => {
                e.target.style.transform = "translateY(-4px)";
                e.target.style.boxShadow = "0 12px 32px rgba(0, 123, 255, 0.12)";
              }}
              onMouseLeave={(e) => {
                ...
                <h3 style={{ color: "#002e6e", marginBottom: 12, fontSize: 20, fontWeight: 700 }}>Recertification</h3>
                <p style={{ color: "#4a5568", fontSize: 15, lineHeight: 1.6 }}>User recertification and validation processes</p>
              </div>
              <div style={{ 
                background: "linear-gradient(135deg, #ffffff 0%, #f0f4ff 100%)", 
                padding: 32, 
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{ color: "#4a5568", fontSize: 15, lineHeight: 1.6 }}>Track and monitor system activities and changes</p>
              </div>
            </div>
          </div>
        );
