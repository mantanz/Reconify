...
# Import audit functionality from new organized structure
...
async def logout(request: Request):
    ...
    try:
        ...
        # Check if token is valid to determine if this is a session expiration
        ...
        if token:
            try:
                ...
                if payload:
                    ...
                    # Token is invalid - this is a session expiration
                    is_session_expired = True
            except:
                # Token is invalid - this is a session expiration
                is_session_expired = True
        
        # Log appropriate event based on whether it's a session expiration
        try:
